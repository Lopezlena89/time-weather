        ...
        <div className="w-11/12 h-[40%]">
            ...
            >
                <div className="flex justify-end">
                    ...
                    <span className="font-semibold  text-lg text-black mt-3 mr-10">Profile</span>
                </div>
                <div className="w-11/12 h-px mt-6 bg-gray-200  absolute left-3 " />
                
                <div className="mt-10 ml-3">
                    <p className="font-semibold  text-lg text-black ">Name: <span className="font-light text-sm">{sessiones.user.name}</span></p>
                    <p className="font-semibold  text-lg text-black ">Mail: <span className="font-light text-sm">{sessiones.user.email}</span></p>
