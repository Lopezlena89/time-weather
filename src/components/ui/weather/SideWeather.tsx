  ...
  return (
    <div className="w-full h-full  bg-transparent">
                    ...
                    <div className="w-full h-2/5 bg-transparent flex justify-center items-center">
                        <div className="w-80 h-4/5 font-light text-white bg-transparent flex flex-col items-center">
                    ...
                    <div className="grid grid-cols-2 grid-rows-2 justify-items-center  w-full h-3/5 bg-transparent ">   
                        ...
                        <div className="w-4/5 h-4/5  bg-transparent flex justify-center items-center rounded-2xl shadow-2xl text-white">
